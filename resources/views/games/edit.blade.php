    ...
    <main>
        ...
        <form method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="form-group">
                ...
                <div id="select-tags">
                    <span style="font-size: 14px">Удаление метки происходит моментально. Добавьте метку снова и сохраните изменения, если вам необходимо её оставить.</span>
            ...
            <div class="form-group">
                ...
                <div class="access-inputs">
                    <label>
                        <input type="radio" name="access_id" id="access"
            ...
            <div class="form-group" id="cover-load">
                <label>Скриншоты <br>
                    <span
                        style="font-size: 14px; color: grey">! Скриншот удаляется навсегда при нажатии крестика !</span>
                </label>
...
@push('script')
    ...
    <script>
        ...
        imgCover = document.querySelector('#cover-img')
